  ...
  return (
    <div className="font-sans">
      ...
      <section className="relative min-h-[100vh] md:h-[60vh] flex items-center justify-center text-center text-white pt-24 sm:pt-28 px-4">
        <img src="/web-banner.jpg" alt="Front-End Development" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="https://api.whatsapp.com/send?phone=923041894256&text=Hey%20I%20am%20contacting%20you%20from%20the%20infoNave%20website." className="inline-block bg-brandOrange text-white px-6 py-3 rounded-xl shadow hover:bg-black transition font-heading">
