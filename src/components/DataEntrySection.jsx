          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <a href="https://api.whatsapp.com/send?phone=17579369494&text=Hey%20I%20am%20contacting%20you%20from%20the%20infoNav%20website." className="bg-brandOrange text-white px-6 py-3 rounded-xl shadow hover:bg-black transition">
